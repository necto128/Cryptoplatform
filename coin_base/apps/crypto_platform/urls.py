...
from apps.crypto_platform.view.admin import (
    AdminGetCryptView,
    AdminGetOrderCryptView,
    AdminUserManagementView
)
from apps.crypto_platform.view.analytic import (
    AnalyticGetOrderCryptView,
    AnalyticGetUserView,
    AnalyticGetTransactionsView
)
...
urlpatterns = [
    ...
    # analytic
    path("analytic/order/", AnalyticGetOrderCryptView.as_view(), name="analytic-order"),
    path("analytic/user/", AnalyticGetUserView.as_view(), name="analytic-user"),
    path("analytic/transactions/<int:user_id>/", AnalyticGetTransactionsView.as_view(), name="analytic-transactions"),
    # administrator
